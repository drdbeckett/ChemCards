...
DATA = [
 ...
 ("Midazolam","Cc1ncc2n1-c1ccc(Cl)cc1C(c1ccccc1F)=NC2",["Drugs","Sedatives & anxiolytics","Anesthetics"],"Versed / Dormicum","C18H13ClFN3"),
 ...
 ("Morphine","CN1CC[C@]23c4c5ccc(O)c4O[C@H]2[C@@H](O)C=C[C@H]3[C@H]1C5",["Drugs","Opioids","Anesthetics"],"MS Contin / Kadian","C17H19NO3"),
 ...
 ("Repinatrabit","C1C[C@H](CN(C1)C(=O)N)N(C2CC2)C(=O)NCC3=C(C=C(C=C3)OC(F)(F)F)F",["Drugs","Others"],"JNT-517","C18H22F4N4O3"),
 # ---- Anesthetics (Morphine also tagged above) ----
 ("Isoflurane","FC(F)(F)C(Cl)OC(F)F",["Drugs","Anesthetics"],"Forane","C3H2ClF5O"),
 ("Nitrous oxide","N#[N+][O-]",["Drugs","Anesthetics"],"N2O / laughing gas","N2O"),
 ("Sevoflurane","FCOC(C(F)(F)F)C(F)(F)F",["Drugs","Anesthetics"],"Sevorane / Ultane","C4H3F7O"),
 ("Ketamine","CNC1(c2ccccc2Cl)CCCCC1=O",["Drugs","Anesthetics"],"Ketalar","C13H16ClNO"),
 ("Propofol","CC(C)c1cccc(C(C)C)c1O",["Drugs","Anesthetics"],"Diprivan","C12H18O"),
 ("Bupivacaine","CCCCN1CCCCC1C(=O)Nc1c(C)cccc1C",["Drugs","Anesthetics"],"Marcaine","C18H28N2O"),
 ("Lidocaine","CCN(CC)CC(=O)Nc1c(C)cccc1C",["Drugs","Anesthetics"],"lignocaine / Xylocaine","C14H22N2O"),
 ("Procaine","CCN(CC)CCOC(=O)c1ccc(N)cc1",["Drugs","Anesthetics"],"Novocaine","C13H20N2O2"),
 ("Atropine","CN1C2CCC1CC(C2)OC(=O)C(CO)c1ccccc1",["Drugs","Anesthetics"],"","C17H23NO3"),
 ...
 ("2-Pyrrolidinone","O=C1CCCN1",["Heterocycles"],"\u03b3-lactam","C4H7NO"),
 ("2-Piperidinone","O=C1CCCCN1",["Heterocycles"],"\u03b4-lactam","C5H9NO"),
 ("Caprolactam","O=C1CCCCCN1",["Heterocycles"],"\u03b5-lactam","C6H11NO"),
 ("\u03b2-Propiolactone","O=C1CCO1",["Heterocycles"],"\u03b2-lactone","C3H4O2"),
 ("\u03b3-Butyrolactone","O=C1CCCO1",["Heterocycles"],"\u03b3-lactone","C4H6O2"),
 ("\u03b4-Valerolactone","O=C1CCCCO1",["Heterocycles"],"\u03b4-lactone","C5H8O2"),
 ...
 # ---- More common heterocycles ----
 ("2H-Pyran","C1C=CC=CO1",["Heterocycles"],"2H-pyran","C5H6O"),
 ("4H-Pyran","O1C=CCC=C1",["Heterocycles"],"4H-pyran","C5H6O"),
 ("Pyrylium","c1ccc[o+]c1",["Heterocycles"],"pyranylium","C5H5O+"),
 ("2H-Thiopyran","C1C=CC=CS1",["Heterocycles"],"thiine","C5H6S"),
 ("4H-Thiopyran","S1C=CCC=C1",["Heterocycles"],"","C5H6S"),
 ("3,4-Dihydro-2H-pyran","C1CCC=CO1",["Heterocycles"],"DHP / dihydropyran","C5H8O"),
 ("2,3-Dihydrofuran","C1CC=CO1",["Heterocycles"],"","C4H6O"),
 ("2,5-Dihydrofuran","C1C=CCO1",["Heterocycles"],"","C4H6O"),
 ("1-Pyrroline","C1CCC=N1",["Heterocycles"],"3,4-dihydro-2H-pyrrole","C4H7N"),
 ("3-Pyrroline","C1C=CCN1",["Heterocycles"],"2,5-dihydro-1H-pyrrole","C4H7N"),
 ("1,3-Dioxole","C1OC=CO1",["Heterocycles"],"","C3H4O2"),
 ("Azepine","C1=CC=CC=CN1",["Heterocycles"],"1H-azepine","C6H7N"),
 ("Oxepine","O1C=CC=CC=C1",["Heterocycles"],"oxepin","C6H6O"),
 ("Thiepine","S1C=CC=CC=C1",["Heterocycles"],"thiepin","C6H6S"),
 ("Indolizidine","C1CCN2CCCC2C1",["Heterocycles"],"octahydroindolizine","C8H15N"),
 ("Quinolizidine","C1CCN2CCCCC2C1",["Heterocycles"],"octahydroquinolizine","C9H17N"),
 ("Chromene","C1=Cc2ccccc2OC1",["Heterocycles"],"2H-chromene / 2H-1-benzopyran","C9H8O"),
 ("Isochromene","C1OC=Cc2ccccc21",["Heterocycles"],"1H-isochromene","C9H8O"),
 ("Isoindoline","C1NCc2ccccc21",["Heterocycles"],"2,3-dihydro-1H-isoindole","C8H9N"),
 ("Phthalan","C1OCc2ccccc21",["Heterocycles"],"1,3-dihydroisobenzofuran","C8H8O"),
 # ---- Functional groups (R = rest of molecule) ----
 ("Alkene","[*:1]C=C[*:2]",["Functional groups"],"olefin / C=C",E),
 ("Alkyne","[*:1]C#C[*:2]",["Functional groups"],"C\u2261C triple bond",E),
 ("Phenyl","[*:1]c1ccccc1",["Functional groups"],"aryl / benzene ring",E),
 ("Methyl","[*:1]C",["Functional groups"],"Me / R\u2013CH3",E),
 ("Ethyl","[*:1]CC",["Functional groups"],"Et / R\u2013CH2CH3",E),
 ("Propyl","[*:1]CCC",["Functional groups"],"n-propyl / Pr",E),
 ("Cyclopropyl","[*:1]C1CC1",["Functional groups"],"cPr",E),
 ("Cyclobutyl","[*:1]C1CCC1",["Functional groups"],"cBu",E),
 ("Methoxy","[*:1]OC",["Functional groups"],"OMe / R\u2013OCH3",E),
 ("Ethoxy","[*:1]OCC",["Functional groups"],"OEt / R\u2013OCH2CH3",E),
 ("Isopropyl","[*:1]C(C)C",["Functional groups"],"iPr / isopropyl",E),
 ("n-Butyl","[*:1]CCCC",["Functional groups"],"n-Bu / nBu",E),
 ("Isobutyl","[*:1]CC(C)C",["Functional groups"],"iBu / isobutyl",E),
 ("sec-Butyl","[*:1]C(C)CC",["Functional groups"],"sBu / sec-butyl",E),
 ("tert-Butyl","[*:1]C(C)(C)C",["Functional groups"],"tBu / tert-butyl",E),
 ("Vinyl","[*:1]C=C",["Functional groups"],"ethenyl / R\u2013CH=CH2",E),
 ("Allyl","[*:1]CC=C",["Functional groups"],"prop-2-en-1-yl / R\u2013CH2CH=CH2",E),
 ("Fluoro","[*:1]F",["Functional groups"],"fluoride / R\u2013F",E),
 ("Chloro","[*:1]Cl",["Functional groups"],"chloride / R\u2013Cl",E),
 ("Bromo","[*:1]Br",["Functional groups"],"bromide / R\u2013Br",E),
 ("Iodo","[*:1]I",["Functional groups"],"iodide / R\u2013I",E),
 ("Hydroxyl","[*:1]O",["Functional groups"],"alcohol / R\u2013OH",E),
 ("Ether","[*:1]O[*:2]",["Functional groups"],"R\u2013O\u2013R",E),
 ("Aldehyde","[*:1]C=O",["Functional groups"],"R\u2013CHO / formyl",E),
 ("Ketone","[*:1]C(=O)[*:2]",["Functional groups"],"carbonyl / acyl / R\u2013CO\u2013R",E),
 ("Carboxylic acid","[*:1]C(=O)O",["Functional groups"],"R\u2013COOH / carboxyl",E),
 ("Ester","[*:1]C(=O)O[*:2]",["Functional groups"],"R\u2013COO\u2013R",E),
 ("Acid anhydride","[*:1]C(=O)OC(=O)[*:2]",["Functional groups"],"anhydride",E),
 ("Acyl chloride","[*:1]C(=O)Cl",["Functional groups"],"acid chloride / R\u2013COCl",E),
 ("Amide","[*:1]C(=O)N([*:2])[*:3]",["Functional groups"],"carboxamide / R\u2013CO\u2013NR2",E),
 ("Carbonate ester","[*:1]OC(=O)O[*:2]",["Functional groups"],"carbonate",E),
 ("Peroxide","[*:1]OO[*:2]",["Functional groups"],"R\u2013O\u2013O\u2013R",E),
 ("Acetal","[*:1]C(O[*:2])O[*:3]",["Functional groups"],"",E),
 ("Primary amine","[*:1]N",["Functional groups"],"R\u2013NH2",E),
 ("Secondary amine","[*:1]N[*:2]",["Functional groups"],"R2NH",E),
 ("Tertiary amine","[*:1]N([*:2])[*:3]",["Functional groups"],"R3N",E),
 ("Imine","[*:1]C=N[*:2]",["Functional groups"],"Schiff base / C=N",E),
 ("Nitrile","[*:1]C#N",["Functional groups"],"cyano / R\u2013CN",E),
 ("Nitro","[*:1][N+](=O)[O-]",["Functional groups"],"R\u2013NO2",E),
 ("Azide","[*:1]N=[N+]=[N-]",["Functional groups"],"R\u2013N3",E),
 ("Isocyanate","[*:1]N=C=O",["Functional groups"],"R\u2013NCO",E),
 ("Oxime","[*:1]C(=NO)[*:2]",["Functional groups"],"C=N\u2013OH",E),
 ("Hydrazine","[*:1]NN",["Functional groups"],"R\u2013NH\u2013NH2",E),
 ("Carbamate","[*:1]OC(=O)N([*:2])[*:3]",["Functional groups"],"urethane",E),
 ("Urea","[*:1]NC(=O)N[*:2]",["Functional groups"],"R\u2013NH\u2013CO\u2013NH\u2013R",E),
 ("Guanidine","[*:1]N=C(N[*:2])N[*:3]",["Functional groups"],"",E),
 ("Thiol","[*:1]S",["Functional groups"],"mercaptan / R\u2013SH",E),
 ("Sulfide","[*:1]S[*:2]",["Functional groups"],"thioether / R\u2013S\u2013R",E),
 ("Disulfide","[*:1]SS[*:2]",["Functional groups"],"R\u2013S\u2013S\u2013R",E),
 ("Sulfoxide","[*:1]S(=O)[*:2]",["Functional groups"],"R\u2013SO\u2013R",E),
 ("Sulfone","[*:1]S(=O)(=O)[*:2]",["Functional groups"],"R\u2013SO2\u2013R",E),
 ("Sulfonic acid","[*:1]S(=O)(=O)O",["Functional groups"],"R\u2013SO3H",E),
 ("Sulfonamide","[*:1]S(=O)(=O)N([*:2])[*:3]",["Functional groups"],"R\u2013SO2\u2013NR2",E),
 ("Thioester","[*:1]C(=O)S[*:2]",["Functional groups"],"R\u2013CO\u2013S\u2013R",E),
 ("Thioamide","[*:1]C(=S)N([*:2])[*:3]",["Functional groups"],"R\u2013CS\u2013NR2",E),
 ("Phosphate","[*:1]OP(=O)(O)O",["Functional groups"],"phosphate ester / R\u2013OPO3H2",E),
 ("Boronic acid","[*:1]B(O)O",["Functional groups"],"R\u2013B(OH)2",E),
 ("Acetyl","[*:1]C(C)=O",["Functional groups"],"Ac / ethanoyl / CH3CO\u2013",E),
 ("Azo","[*:1]N=N[*:2]",["Functional groups"],"diazenyl / R\u2013N=N\u2013R",E),
 ("Nitrate ester","[*:1]O[N+](=O)[O-]",["Functional groups"],"nitrate / R\u2013ONO2",E),
 ("Aminal","[*:1]NCN[*:2]",["Functional groups"],"gem-diamine",E),
 ("Hemiacetal","[*:1]C(O)O[*:2]",["Functional groups"],"R\u2013CH(OH)\u2013OR",E),
 ("Hemiaminal","[*:1]C(O)N[*:2]",["Functional groups"],"carbinolamine / R\u2013CH(OH)\u2013NR2",E),
 ("Thial","[*:1]C=S",["Functional groups"],"thioaldehyde / R\u2013CHS",E),
 ("Thioketone","[*:1]C(=S)[*:2]",["Functional groups"],"thione / R2C=S",E),
 ("Phosphine","[*:1]P([*:2])[*:3]",["Functional groups"],"R3P / phosphane",E),
 # ---- Protecting groups (shown on the atom they protect; R = substrate) ----
 ("Boc","[*:1]NC(=O)OC(C)(C)C",["Protecting groups"],"tert-butoxycarbonyl / Boc",E),
 ("Cbz","[*:1]NC(=O)OCc1ccccc1",["Protecting groups"],"benzyloxycarbonyl / Cbz / Z",E),
 ("Fmoc","[*:1]NC(=O)OCC1c2ccccc2-c2ccccc21",["Protecting groups"],"fluorenylmethyloxycarbonyl / Fmoc",E),
 ("Troc","[*:1]NC(=O)OCC(Cl)(Cl)Cl",["Protecting groups"],"trichloroethoxycarbonyl / Troc",E),
 ("Acetamide","[*:1]NC(C)=O",["Protecting groups"],"N-acetyl / Ac",E),
 ("Trifluoroacetamide","[*:1]NC(=O)C(F)(F)F",["Protecting groups"],"N-TFA",E),
 ("Tosylamide","[*:1]NS(=O)(=O)c1ccc(C)cc1",["Protecting groups"],"tosyl / Ts / N-Ts",E),
 ("N-Benzylamine","[*:1]NCc1ccccc1",["Protecting groups"],"N-benzyl / Bn",E),
 ("TMS ether","[*:1]O[Si](C)(C)C",["Protecting groups"],"trimethylsilyl / TMS",E),
 ("TBS ether","[*:1]O[Si](C)(C)C(C)(C)C",["Protecting groups"],"TBS / TBDMS",E),
 ("TIPS ether","[*:1]O[Si](C(C)C)(C(C)C)C(C)C",["Protecting groups"],"triisopropylsilyl / TIPS",E),
 ("TBDPS ether","[*:1]O[Si](c1ccccc1)(c1ccccc1)C(C)(C)C",["Protecting groups"],"TBDPS",E),
 ("Benzyl ether","[*:1]OCc1ccccc1",["Protecting groups"],"O-benzyl / OBn",E),
 ("PMB ether","[*:1]OCc1ccc(OC)cc1",["Protecting groups"],"p-methoxybenzyl / PMB",E),
 ("MOM ether","[*:1]OCOC",["Protecting groups"],"methoxymethyl / MOM",E),
 ("THP ether","[*:1]OC1CCCCO1",["Protecting groups"],"tetrahydropyranyl / THP",E),
 ("Trityl ether","[*:1]OC(c1ccccc1)(c1ccccc1)c1ccccc1",["Protecting groups"],"trityl / Tr / triphenylmethyl",E),
 ("Acetate ester","[*:1]OC(C)=O",["Protecting groups"],"O-acetyl / OAc",E),
 ("Pivaloate","[*:1]OC(=O)C(C)(C)C",["Protecting groups"],"pivaloyl / Piv",E),
 ("Benzoate","[*:1]OC(=O)c1ccccc1",["Protecting groups"],"benzoyl / Bz",E),
 ("Allyl ether","[*:1]OCC=C",["Protecting groups"],"O-allyl",E),
 ("Methyl ester","[*:1]C(=O)OC",["Protecting groups"],"CO2Me",E),
 ("tert-Butyl ester","[*:1]C(=O)OC(C)(C)C",["Protecting groups"],"CO2tBu",E),
 ("Benzyl ester","[*:1]C(=O)OCc1ccccc1",["Protecting groups"],"CO2Bn",E),
 ("Acetonide","[*:1]OC(C)(C)O[*:2]",["Protecting groups"],"isopropylidene",E),
 # ---- Vitamins (Biochemistry) ----
 ("Retinol","CC1=C(C=CC(C)=CC=CC(C)=CCO)C(C)(C)CCC1",["Vitamins"],"vitamin A","C20H30O"),
 ("Thiamine","Cc1ncc(C[n+]2csc(CCO)c2C)c(N)n1",["Vitamins"],"vitamin B1 / B1","C12H17N4OS+"),
 ("Riboflavin","Cc1cc2nc3c(=O)[nH]c(=O)nc-3n(CC(O)C(O)C(O)CO)c2cc1C",["Vitamins"],"vitamin B2 / B2","C17H20N4O6"),
 ("Niacin","O=C(O)c1cccnc1",["Vitamins"],"vitamin B3 / nicotinic acid","C6H5NO2"),
 ("Pantothenic acid","CC(C)(CO)C(O)C(=O)NCCC(=O)O",["Vitamins"],"vitamin B5","C9H17NO5"),
 ("Pyridoxine","Cc1ncc(CO)c(CO)c1O",["Vitamins"],"vitamin B6","C8H11NO3"),
 ("Biotin","O=C(O)CCCCC1SCC2NC(=O)NC12",["Vitamins"],"vitamin B7 / vitamin H","C10H16N2O3S"),
 ("Folic acid","Nc1nc2ncc(CNc3ccc(C(=O)NC(CCC(=O)O)C(=O)O)cc3)nc2c(=O)[nH]1",["Vitamins"],"vitamin B9 / folate","C19H19N7O6"),
 ("Ascorbic acid","OCC(O)C1OC(=O)C(O)=C1O",["Vitamins"],"vitamin C","C6H8O6"),
 ("Cholecalciferol","CC(CCCC(C)C)C1CCC2C(=CC=C3CC(O)CCC3=C)CCCC12C",["Vitamins"],"vitamin D3","C27H44O"),
 ("\u03b1-Tocopherol","Cc1c(C)c2c(c(C)c1O)CCC(C)(CCCC(C)CCCC(C)CCCC(C)C)O2",["Vitamins"],"vitamin E","C29H50O2"),
 ("Phylloquinone","CC(C)CCCC(C)CCCC(C)CCCC(C)=CCc1c(C)c(=O)c2ccccc2c1=O",["Vitamins"],"vitamin K1 / vitamin K","C31H46O2"),
]
